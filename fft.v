...
pub fn (a Array) fft(n int, axis int, norm FftNorm) Array {
	res := new_result()
	check_res(C.mlx_fft_fft(&res, a.raw(), n, axis, int(norm), def_stream()), res)
...
pub fn (a Array) ifft(n int, axis int, norm FftNorm) Array {
	res := new_result()
	check_res(C.mlx_fft_ifft(&res, a.raw(), n, axis, int(norm), def_stream()), res)
	return wrap_array(res)
}
...
pub fn (a Array) rfft(n int, axis int, norm FftNorm) Array {
	res := new_result()
	check_res(C.mlx_fft_rfft(&res, a.raw(), n, axis, int(norm), def_stream()), res)
	return wrap_array(res)
}
...
pub fn (a Array) irfft(n int, axis int, norm FftNorm) Array {
	res := new_result()
	check_res(C.mlx_fft_irfft(&res, a.raw(), n, axis, int(norm), def_stream()), res)
	return wrap_array(res)
}
...
pub fn (a Array) fftn(n []int, axes []int, norm FftNorm) Array {
	res := new_result()
	check_res(C.mlx_fft_fftn(&res, a.raw(), n.data, n.len, axes.data, axes.len, int(norm),
		def_stream()), res)
	return wrap_array(res)
}
...
pub fn (a Array) ifftn(n []int, axes []int, norm FftNorm) Array {
	res := new_result()
	check_res(C.mlx_fft_ifftn(&res, a.raw(), n.data, n.len, axes.data, axes.len, int(norm),
		def_stream()), res)
	return wrap_array(res)
}
...
pub fn (a Array) rfftn(n []int, axes []int, norm FftNorm) Array {
	res := new_result()
	check_res(C.mlx_fft_rfftn(&res, a.raw(), n.data, n.len, axes.data, axes.len, int(norm),
		def_stream()), res)
	return wrap_array(res)
}
...
pub fn (a Array) irfftn(n []int, axes []int, norm FftNorm) Array {
	res := new_result()
	check_res(C.mlx_fft_irfftn(&res, a.raw(), n.data, n.len, axes.data, axes.len, int(norm),
		def_stream()), res)
	return wrap_array(res)
}
...
pub fn (a Array) fftshift() Array {
	res := new_result()
	check_res(C.mlx_fft_fftshift(&res, a.raw(), unsafe { nil }, 0, def_stream()), res)
	return wrap_array(res)
}
...
pub fn (a Array) ifftshift() Array {
	res := new_result()
	check_res(C.mlx_fft_ifftshift(&res, a.raw(), unsafe { nil }, 0, def_stream()), res)
	return wrap_array(res)
}
...
pub fn fftfreq(n int, d f64) Array {
	res := new_result()
	check_res(C.mlx_fft_fftfreq(&res, n, d, def_stream()), res)
	return wrap_array(res)
}
...
pub fn rfftfreq(n int, d f64) Array {
	res := new_result()
	check_res(C.mlx_fft_rfftfreq(&res, n, d, def_stream()), res)
	return wrap_array(res)
}
